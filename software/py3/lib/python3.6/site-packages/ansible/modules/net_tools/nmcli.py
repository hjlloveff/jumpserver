...
options:
    ...
    type:
        required: False
        choices: [ ethernet, team, team-subordinate, bond, bond-subordinate, bridge, vlan ]
        description:
...
def main():
    ...
    module=AnsibleModule(
        argument_spec=dict(
            ...
            type=dict(required=False, default=None, choices=['ethernet', 'team', 'team-subordinate', 'bond', 'bond-subordinate', 'bridge', 'vlan'], type='str'),
    ...
    if nmcli.type=='team-subordinate' and nmcli.main is None:
        nmcli.module.fail_json(msg="You haven't specified a name for the main so we're not changing a thing")
