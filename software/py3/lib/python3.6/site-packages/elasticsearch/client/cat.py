...
class CatClient(NamespacedClient):
    ...
    @query_params('bytes', 'format', 'h', 'help', 'local', 'main_timeout',
        's', 'v')
    ...
    @query_params('format', 'h', 'help', 'local', 'main_timeout', 's', 'ts',
        'v')
    ...
    def main(self, params=None):
        ...
        :arg v: Verbose mode. Display column headers, default False
        """
        return self.transport.perform_request('GET', '/_cat/main',
            params=params)

    @query_params('format', 'full_id', 'h', 'help', 'local', 'main_timeout',
        's', 'v')
    ...
    @query_params('format', 'h', 'help', 'local', 'main_timeout', 's', 'size',
        'v')
    ...
    @query_params('format', 'h', 'help', 'ignore_unavailable', 'main_timeout',
        's', 'v')
